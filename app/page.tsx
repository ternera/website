  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <p>
          I'm a firm believer in <a href="https://en.wiktionary.org/wiki/touch_grass" target="_blank" rel="noopener noreferrer">touching grass</a> and highly recommend it. Get outside and do things! 😀 Oh, and if you haven't received Jesus Christ's free gift of salvation, maybe think about that?
        </p>
      </div>
    </section>
  );
