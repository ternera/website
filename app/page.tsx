  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        <p>
        I'm just a dude who is interested in IT, coding, community management, and technology in general. I wear a bunch of different hats on the inernet.
        </p>
        <p>
        <li>I am always working to become more like Jesus in thoughts and deeds.</li>
        <li>I love beautiful things, such as the outdoors and artwork.</li>
        ...
        I'm happy to chat with you. feel free to reach out to me!
        </p>
        <p>
        ...
        I've been able to automate some ruitine moderation tasks by using writing filters and bots. It's also taught me a lot about customer service and conflict resolution! 
        </p>
        <p> 
