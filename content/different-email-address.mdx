...
This makes it clear that anyone can submit a Zendesk ticket using any email address - they could flood a company with support requests in an attempt to get you banned from the platform. In the case above, it appears Discord did not act on the spam tickets, but who knows what other companies would do.
